    ...
    <>
      <div className="row justify-content-left">
        <div
          ...
          className="carousel carousel-dark slide p-5 col-lg-6"
          ...
          <div className="carousel-inner">
            ...
            <div className="carousel-item" data-bs-interval="2000">
              ...
              <div className="carousel-caption d-none d-md-block d-sm-none d-lg-block text-white fw-bold">
                ...
                <p>
                  S stands for Signal, O stands for Orientation, R stands for
                  Regulator, T stands for Time, E stands for Equalize and D
                  stands for Descent.
                </p>
              </div>
            </div>
            <div className="carousel-item" data-bs-interval="2000">
              ...
              <div className="carousel-caption d-none d-md-block d-sm-none d-lg-block text-white fw-bold">
                ...
                <p>
                  A bad day on the jet ski is better than a good day at work.
                </p>
              </div>
            </div>
          </div>
